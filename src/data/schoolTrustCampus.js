...
export const buildings = [
  ...
  },
  {
    ...
    statusText: 'Reserved. State chapter under formation.',
    role: 'State chapter',
    domain: 'pending — prototype build',
    href: '#oastl-tbd',
    whatToDo:
      "The Oregon state chapter of the ASTL coalition. Oregon is the live test case of the national project — the active litigation in ASTL v. Oregon, the Elliott State Forest history, the OASTL board, and the local coalition organizing around the state's fiduciary record. Oregon House will be the working chapter site once the prototype lands; in the interim, Oregon-specific work lives at the ASTL National building.",
    cta: 'Updates coming',
    x: 62,
    y: 66,
  },
